...
mv_cookies = {
    "r3autologin": "\"bsmv\"",
    "JSESSIONID": "2FD6D6F01AEEC271696AC9A6745469AB.jp22"
}
...
ni_headers = json_headers_base | {
    "Origin": "https://voris.wolterskluwer-online.de",
    "Referer": "https://voris.wolterskluwer-online.de/bsni/search",
    "juris-portalid": "bsni"
}
ni_cookies = {
    "r3autologin": "\"bsni\""
}
ni_body = '{"clientID":"bsni","clientVersion":"bsni - V06_07_00 - 23.06.2022 11:20","r3ID":"%sT%sZ"}'
